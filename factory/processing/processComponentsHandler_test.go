...
func TestManagedProcessComponents_Create(t *testing.T) {
	...
	t.Run("should work with getters", func(t *testing.T) {
		...
		require.True(t, check.IfNil(managedProcessComponents.TransactionCostSimulator()))
		...
		require.False(t, check.IfNil(managedProcessComponents.TransactionCostSimulator()))
