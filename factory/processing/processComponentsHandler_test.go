...
func testManagedProcessComponentsCreateShouldWork(t *testing.T, shardID uint32, rtch *mainFactoryMocks.RunTypeComponentsStub) {
	...
	require.True(t, check.IfNil(managedProcessComponents.IncomingHeaderSubscriber()))
	...
	require.False(t, check.IfNil(managedProcessComponents.IncomingHeaderSubscriber()))
