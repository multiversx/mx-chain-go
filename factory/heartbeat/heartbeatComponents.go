...
type heartbeatComponents struct {
	...
	monitor        factory.HeartbeatMonitor
	sender         factory.HeartbeatSender
	storer         factory.HeartbeatStorer
...
func (hcf *heartbeatComponentsFactory) startSendingHeartbeats(ctx context.Context, sender factory.HeartbeatSender, monitor factory.HeartbeatMonitor) {
