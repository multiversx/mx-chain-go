...
var _ factory.ComponentHandler = (*managedHeartbeatComponents)(nil)
var _ factory.HeartbeatComponentsHolder = (*managedHeartbeatComponents)(nil)
var _ factory.HeartbeatComponentsHandler = (*managedHeartbeatComponents)(nil)
...
func (mhc *managedHeartbeatComponents) Monitor() factory.HeartbeatMonitor {
	mhc.mutHeartbeatComponents.RLock()
	defer mhc.mutHeartbeatComponents.RUnlock()
...
func (mhc *managedHeartbeatComponents) Sender() factory.HeartbeatSender {
	mhc.mutHeartbeatComponents.RLock()
	defer mhc.mutHeartbeatComponents.RUnlock()
...
func (mhc *managedHeartbeatComponents) Storer() factory.HeartbeatStorer {
	mhc.mutHeartbeatComponents.RLock()
	defer mhc.mutHeartbeatComponents.RUnlock()
...
func (mhc *managedHeartbeatComponents) String() string {
	return factory.HeartbeatComponentsName
}
