...
func TestManagedProcessComponents_Create_ShouldWork(t *testing.T) {
	...
	require.Nil(t, managedProcessComponents.ArwenChangeLocker())
	require.Nil(t, managedProcessComponents.CurrentEpochProvider())
	require.Nil(t, managedProcessComponents.NodeRedundancyHandler())
	require.Nil(t, managedProcessComponents.WhiteListHandler())
	require.Nil(t, managedProcessComponents.WhiteListerVerifiedTxs())
	require.Nil(t, managedProcessComponents.RequestedItemsHandler())
	require.Nil(t, managedProcessComponents.ImportStartHandler())
	require.Nil(t, managedProcessComponents.HistoryRepository())
	require.Nil(t, managedProcessComponents.TransactionSimulatorProcessor())
	require.Nil(t, managedProcessComponents.FallbackHeaderValidator())
	require.Nil(t, managedProcessComponents.PeerShardMapper())
	require.Nil(t, managedProcessComponents.ShardCoordinator())
	...
	require.NotNil(t, managedProcessComponents.CurrentEpochProvider())
	require.NotNil(t, managedProcessComponents.NodeRedundancyHandler())
	require.NotNil(t, managedProcessComponents.WhiteListHandler())
	require.NotNil(t, managedProcessComponents.WhiteListerVerifiedTxs())
	require.NotNil(t, managedProcessComponents.RequestedItemsHandler())
	require.NotNil(t, managedProcessComponents.ImportStartHandler())
	require.NotNil(t, managedProcessComponents.HistoryRepository())
	require.NotNil(t, managedProcessComponents.TransactionSimulatorProcessor())
	require.NotNil(t, managedProcessComponents.FallbackHeaderValidator())
	require.NotNil(t, managedProcessComponents.PeerShardMapper())
	require.NotNil(t, managedProcessComponents.ShardCoordinator())
}
