...
func (pcf *processComponentsFactory) newShardBlockProcessor(
	...
	argumentsBaseProcessor := block.ArgBaseProcessor{
		...
		FeeHandler:                txFeeHandler,
		StateCheckpointModulus:    pcf.config.StateTriesConfig.CheckpointRoundsModulus,
		UserStatePruningQueueSize: pcf.config.StateTriesConfig.UserStatePruningQueueSize,
		BlockSizeThrottler:        blockSizeThrottler,
		Indexer:                   pcf.statusComponents.ElasticIndexer(),
		TpsBenchmark:              pcf.statusComponents.TpsBenchmark(),
...
func (pcf *processComponentsFactory) newMetaBlockProcessor(
	...
	arguments := block.ArgMetaProcessor{
		...
		PeerStatePruningQueueSize:    pcf.config.StateTriesConfig.PeerStatePruningQueueSize,
	}
