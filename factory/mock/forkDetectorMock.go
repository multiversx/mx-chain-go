...
func (fdm *ForkDetectorMock) ReconcileFinalCheckpoint(nonce uint64) bool {
...
func (fdm *ForkDetectorMock) ReconcileFinalCheckpointFromAuthority(nonce uint64, selectedHash []byte) bool {
