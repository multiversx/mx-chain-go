...
func createMockConsensusComponentsFactoryArgs() consensusComp.ConsensusComponentsFactoryArgs {
	return consensusComp.ConsensusComponentsFactoryArgs{
		...
		CoreComponents: &mock.CoreComponentsMock{
			...
			ChainIdCalled:               nil,
			MinTransactionVersionCalled: nil,
			RoundHandlerField:           nil,
			EconomicsHandler:            nil,
			APIEconomicsHandler:         nil,
			RatingsConfig:               nil,
			RatingHandler:               nil,
			...
			EnableRoundsHandlerField:     nil,
			EpochNotifierWithConfirm:     nil,
			TxVersionCheckHandler:        nil,
			ChanStopProcess:              nil,
			StartTime:                    time.Time{},
			NodeTypeProviderField:        nil,
			WasmVMChangeLockerInternal:   nil,
			ProcessStatusHandlerInternal: nil,
			HardforkTriggerPubKeyField:   nil,
			EnableEpochsHandlerField:     nil,
		},
