...
func TestManagedRunTypeComponents_Create(t *testing.T) {
	...
	t.Run("should work with getters", func(t *testing.T) {
		...
		require.Nil(t, managedRunTypeComponents.GenesisMetaBlockCreator())
		...
		require.Nil(t, managedRunTypeComponents.InterceptorsContainerCreator())
		require.Nil(t, managedRunTypeComponents.RequesterContainerCreator())
		require.Nil(t, managedRunTypeComponents.ShardResolversContainerCreator())
		require.Nil(t, managedRunTypeComponents.IncomingHeaderHandler())
		...
		require.NotNil(t, managedRunTypeComponents.GenesisMetaBlockCreator())
		...
		require.NotNil(t, managedRunTypeComponents.InterceptorsContainerCreator())
		require.NotNil(t, managedRunTypeComponents.RequesterContainerCreator())
		require.NotNil(t, managedRunTypeComponents.ShardResolversContainerCreator())
		require.NotNil(t, managedRunTypeComponents.IncomingHeaderHandler())
