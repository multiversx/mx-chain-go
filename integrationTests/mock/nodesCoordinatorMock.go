...
// SetNodesPerShards -
func (ncm *NodesCoordinatorMock) SetNodesPerShards(_ map[uint32][]nodesCoordinator.Validator, _ map[uint32][]nodesCoordinator.Validator, _ uint32) error {
	return nil
}
...
// SetNodesConfig -
func (ncs *NodesCoordinatorMock) SetNodesConfig(_ map[uint32]*nodesCoordinator.EpochNodesConfig) {
	panic("not implemented")
}
