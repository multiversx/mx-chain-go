...
define void @doSomething() local_unnamed_addr #0 {
entry:
  %call = tail call i32 @transferValue(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @firstScAddress, i32 0, i32 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @zero, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i32 9) #3
  ret void
}
...
define void @callBack() local_unnamed_addr #2 {
entry:
  ret void
}

; Function Attrs: norecurse nounwind readnone
define void @_main() local_unnamed_addr #2 {
entry:
  ret void
}
