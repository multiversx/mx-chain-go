; ModuleID = 'testdata/second/second.c'
source_filename = "testdata/second/second.c"
...
entry:
  call void @asyncCall(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @firstScAddress, i32 0, i32 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @zero, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i32 9)
  ret void
}
