...
type ForkDetectorMock struct {
	AddHeaderCalled                  func(header data.HeaderHandler, hash []byte, isReceived bool) error
...
func (fdm *ForkDetectorMock) AddHeader(header data.HeaderHandler, hash []byte, isReceived bool) error {
