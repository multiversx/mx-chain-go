...
func createTestApiConfig() config.ApiRoutesConfig {
	routes := map[string][]string{
		...
		"transaction": {"/send", "/simulate", "/send-multiple", "/cost", "/:txhash", "/pool/by-sender/:sender/parameters/:parameters", "/pool/by-sender/last-nonce/:sender", "/pool/by-sender/nonce-gaps/:sender"},
