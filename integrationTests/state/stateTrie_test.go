...
func TestTrieDB_RecreateFromStorageShouldWork(t *testing.T) {
	...
	tr1, _ := trie.NewTrie(store, integrationTests.TestMarshalizer, hasher, memorydb.New())
...
func TestAccountsDB_CommitTwoOkAccountsWithRecreationFromStorageShouldWork(t *testing.T) {
	...
	tr, _ := trie.NewTrie(mu, integrationTests.TestMarshalizer, integrationTests.TestHasher, memorydb.New())
...
func createAccounts(
	...
	tr, _ := trie.NewTrie(store, integrationTests.TestMarshalizer, integrationTests.TestHasher, memorydb.New())
	adb, _ := state.NewAccountsDB(tr, integrationTests.TestHasher, integrationTests.TestMarshalizer, factory.NewAccountCreator())
