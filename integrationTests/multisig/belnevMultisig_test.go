...
func TestBelnev_MultiSigningMultipleSignersVerifyWithNodesCoordinatorWrongGroup(t *testing.T) {
	consensusGroupSize := uint16(21)
	suite := kyber.NewBlakeSHA256Ed25519()
	kg := signing.NewKeyGenerator(suite)
...
func TestBelnev_MultiSigningMultipleSignersVerifyWithNodesCoordinatorOK(t *testing.T) {
