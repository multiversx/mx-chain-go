...
func TestVmDeployWithTransferAndGasShouldDeploySCCode(t *testing.T) {
	...
	txProc, accnts, _ := vm.CreatePreparedTxProcessorAndAccountsWithArwenVM(t, senderNonce, senderAddressBytes, senderBalance)
...
func runWASMVMBenchmark(t *testing.T, fileSC string, numRun int, testingValue uint64) {
	...
	txProc, accnts, _ := vm.CreatePreparedTxProcessorAndAccountsWithArwenVM(t, ownerNonce, ownerAddressBytes, ownerBalance)
	...
	scAddress, _ := hex.DecodeString("000000000000000009091a2983b179a480a60c4308da48f13b4480dbb4d33132")
