...
func TestAsyncCallShouldWork(t *testing.T) {
	...
	testIndexer = vm.CreateTestIndexer(t, testContextSecondContract.ShardCoordinator, testContextSecondContract.EconomicsData, testContextSender.TxsLogsProcessor)
