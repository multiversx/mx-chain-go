...
func TestAsyncESDTTransferWithSCCallShouldWork(t *testing.T) {
	...
	secondSCAddress := utils.DoDeploySecond(t, testContextSecondContract, "../../esdt/testdata/second-contract.wasm", secondContractOwnerAcc, gasPrice, gasLimitDeploy, argsSecond)
	...
	firstSCAddress := utils.DoDeploySecond(t, testContextFirstContract, "../../esdt/testdata/first-contract.wasm", firstContractOwnerAcc, gasPrice, gasLimitDeploy, args)
	...
	// !!!!!!!!!!!!!! take a look here
	scrForSecondContract := intermediateTxs[0]
