(module
  ...
  (import "ethereum" "getCallDataSize" (func $env.getCallDataSize (type 0)))
  (import "ethereum" "revert" (func $env.revert (type 1)))
  (import "ethereum" "callDataCopy" (func $env.callDataCopy (type 2)))
  (import "ethereum" "finish" (func $env.finish (type 1)))
  (import "ethereum" "storageLoad" (func $env.storageLoad (type 1)))
  (import "ethereum" "getCaller" (func $env.getCaller (type 3)))
  (import "ethereum" "storageStore" (func $env.storageStore (type 1)))
