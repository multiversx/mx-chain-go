...
func TestChainSimulator_EGLD_MultiTransfer(t *testing.T) {
	...
	cs, err := chainSimulator.NewChainSimulator(chainSimulator.ArgsChainSimulator{
		...
		SupernovaRoundDurationInMillis: vm2.RoundDurationInMillis,
	...
	egldValue := vm2.OneEGLD.Mul(vm2.OneEGLD, big.NewInt(3))
...
func TestChainSimulator_IssueToken_EGLDTicker(t *testing.T) {
	...
	vm2.Log.Info("Initial setup: IssueTx token (before the activation of EGLDInMultiTransferFlag)")
	...
	vm2.Log.Info("IssueTx token (after activation of EGLDInMultiTransferFlag)")
