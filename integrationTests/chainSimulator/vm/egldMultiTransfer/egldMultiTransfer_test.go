...
func TestChainSimulator_IssueToken_EGLDTicker(t *testing.T) {
	...
	vm2.Log.Info("Initial setup: Issue token (before the activation of EGLDInMultiTransferFlag)")
	...
	vm2.Log.Info("Issue token (after activation of EGLDInMultiTransferFlag)")
