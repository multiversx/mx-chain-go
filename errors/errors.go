...
// ErrNilSCRProcessorCreator signals that a nil additional storage service creator has been provided
var ErrNilSCRProcessorCreator = errors.New("nil scr processor creator")
