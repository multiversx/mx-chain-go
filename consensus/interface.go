...
type Rounder interface {
	Index() int32
	UpdateRound(time.Time, time.Time) // UpdateRound updates the index and the time stamp of the round depending of the genesis time and the current time given
	TimeStamp() time.Time
