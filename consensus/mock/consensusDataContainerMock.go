...
func (cdc *ConsensusCoreMock) ValidatorGroupSelector() consensus.NodesCoordinator {
...
func (cdc *ConsensusCoreMock) SetValidatorGroupSelector(validatorGroupSelector consensus.NodesCoordinator) {
