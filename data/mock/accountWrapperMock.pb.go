...
func (m *AccountWrapMockData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AccountWrapMockData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
var fileDescriptor_8fc2a076cf238279 = []byte{
	...
	0x4a, 0x53, 0x25, 0x18, 0x15, 0x18, 0x35, 0x98, 0x83, 0x10, 0x02, 0x4e, 0x56, 0x17, 0x1e, 0xca,
	...
	0x1b, 0x8f, 0xe5, 0x18, 0xa2, 0x58, 0x72, 0xf3, 0x93, 0xb3, 0x93, 0xd8, 0xc0, 0xf6, 0x1a, 0x03,
	0x02, 0x00, 0x00, 0xff, 0xff, 0x61, 0xd4, 0x12, 0xe3, 0xd1, 0x00, 0x00, 0x00,
}
