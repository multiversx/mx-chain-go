...
type ValidatorApiResponse struct {
	NumLeaderSuccess         uint32  `protobuf:"varint,1,opt,name=NumLeaderSuccess,proto3" json:"NumLeaderSuccess"`
	NumLeaderFailure         uint32  `protobuf:"varint,2,opt,name=NumLeaderFailure,proto3" json:"NumLeaderFailure"`
	NumValidatorSuccess      uint32  `protobuf:"varint,3,opt,name=NumValidatorSuccess,proto3" json:"NumValidatorSuccess"`
	NumValidatorFailure      uint32  `protobuf:"varint,4,opt,name=NumValidatorFailure,proto3" json:"NumValidatorFailure"`
...
var fileDescriptor_26bd0314afcce126 = []byte{
	...
	,
}
