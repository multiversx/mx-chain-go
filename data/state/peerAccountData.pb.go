...
type ValidatorApiResponse struct {
	...
	TotalNrLeaderSuccess    uint32  `protobuf:"varint,7,opt,name=TotalNrLeaderSuccess,proto3" json:"totalNrLeaderSuccess"`
	TotalNrLeaderFailure    uint32  `protobuf:"varint,8,opt,name=TotalNrLeaderFailure,proto3" json:"totalNrLeaderFailure"`
	TotalNrValidatorSuccess uint32  `protobuf:"varint,9,opt,name=TotalNrValidatorSuccess,proto3" json:"totalNrValidatorSuccess"`
	TotalNrValidatorFailure uint32  `protobuf:"varint,10,opt,name=TotalNrValidatorFailure,proto3" json:"totalNrValidatorFailure"`
}
...
func (m *ValidatorApiResponse) GetTotalNrLeaderSuccess() uint32 {
	if m != nil {
		return m.TotalNrLeaderSuccess
	}
	return 0
}

func (m *ValidatorApiResponse) GetTotalNrLeaderFailure() uint32 {
	if m != nil {
		return m.TotalNrLeaderFailure
	}
	return 0
}

func (m *ValidatorApiResponse) GetTotalNrValidatorSuccess() uint32 {
	if m != nil {
		return m.TotalNrValidatorSuccess
	}
	return 0
}

func (m *ValidatorApiResponse) GetTotalNrValidatorFailure() uint32 {
	if m != nil {
		return m.TotalNrValidatorFailure
	}
	return 0
}
...
type PeerAccountData struct {
	...
	ConsecutiveProposerMisses  uint32        `protobuf:"varint,18,opt,name=ConsecutiveProposerMisses,proto3" json:"ConsecutiveProposerMisses,omitempty"`
	TotalValidatorSuccessRate  SignRate      `protobuf:"bytes,19,opt,name=TotalValidatorSuccessRate,proto3" json:"TotalValidatorSuccessRate"`
	TotalLeaderSuccessRate     SignRate      `protobuf:"bytes,20,opt,name=TotalLeaderSuccessRate,proto3" json:"TotalLeaderSuccessRate"`
}
...
var fileDescriptor_26bd0314afcce126 = []byte{
	...
	,
}
...
func (this *ValidatorApiResponse) Equal(that interface{}) bool {
	...
	if this.TotalNrLeaderSuccess != that1.TotalNrLeaderSuccess {
		return false
	}
	if this.TotalNrLeaderFailure != that1.TotalNrLeaderFailure {
		return false
	}
	if this.TotalNrValidatorSuccess != that1.TotalNrValidatorSuccess {
		return false
	}
	if this.TotalNrValidatorFailure != that1.TotalNrValidatorFailure {
		return false
	}
	return true
}
...
func (this *ValidatorApiResponse) GoString() string {
	...
	s = append(s, "TotalNrLeaderSuccess: "+fmt.Sprintf("%#v", this.TotalNrLeaderSuccess)+",\n")
	s = append(s, "TotalNrLeaderFailure: "+fmt.Sprintf("%#v", this.TotalNrLeaderFailure)+",\n")
	s = append(s, "TotalNrValidatorSuccess: "+fmt.Sprintf("%#v", this.TotalNrValidatorSuccess)+",\n")
	s = append(s, "TotalNrValidatorFailure: "+fmt.Sprintf("%#v", this.TotalNrValidatorFailure)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *ValidatorApiResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TotalNrValidatorFailure != 0 {
		i = encodeVarintPeerAccountData(dAtA, i, uint64(m.TotalNrValidatorFailure))
		i--
		dAtA[i] = 0x50
	}
	if m.TotalNrValidatorSuccess != 0 {
		i = encodeVarintPeerAccountData(dAtA, i, uint64(m.TotalNrValidatorSuccess))
		i--
		dAtA[i] = 0x48
	}
	if m.TotalNrLeaderFailure != 0 {
		i = encodeVarintPeerAccountData(dAtA, i, uint64(m.TotalNrLeaderFailure))
		i--
		dAtA[i] = 0x40
	}
	if m.TotalNrLeaderSuccess != 0 {
		i = encodeVarintPeerAccountData(dAtA, i, uint64(m.TotalNrLeaderSuccess))
		i--
		dAtA[i] = 0x38
	}
	if m.TempRating != 0 {
...
func (m *ValidatorApiResponse) Size() (n int) {
	...
	if m.TotalNrLeaderSuccess != 0 {
		n += 1 + sovPeerAccountData(uint64(m.TotalNrLeaderSuccess))
	}
	if m.TotalNrLeaderFailure != 0 {
		n += 1 + sovPeerAccountData(uint64(m.TotalNrLeaderFailure))
	}
	if m.TotalNrValidatorSuccess != 0 {
		n += 1 + sovPeerAccountData(uint64(m.TotalNrValidatorSuccess))
	}
	if m.TotalNrValidatorFailure != 0 {
		n += 1 + sovPeerAccountData(uint64(m.TotalNrValidatorFailure))
	}
	return n
}
...
func (this *ValidatorApiResponse) String() string {
	...
	s := strings.Join([]string{`&ValidatorApiResponse{`,
		...
		`TotalNrLeaderSuccess:` + fmt.Sprintf("%v", this.TotalNrLeaderSuccess) + `,`,
		`TotalNrLeaderFailure:` + fmt.Sprintf("%v", this.TotalNrLeaderFailure) + `,`,
		`TotalNrValidatorSuccess:` + fmt.Sprintf("%v", this.TotalNrValidatorSuccess) + `,`,
		`TotalNrValidatorFailure:` + fmt.Sprintf("%v", this.TotalNrValidatorFailure) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ValidatorApiResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalNrLeaderSuccess", wireType)
			}
			m.TotalNrLeaderSuccess = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPeerAccountData
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalNrLeaderSuccess |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalNrLeaderFailure", wireType)
			}
			m.TotalNrLeaderFailure = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPeerAccountData
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalNrLeaderFailure |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalNrValidatorSuccess", wireType)
			}
			m.TotalNrValidatorSuccess = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPeerAccountData
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalNrValidatorSuccess |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalNrValidatorFailure", wireType)
			}
			m.TotalNrValidatorFailure = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPeerAccountData
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalNrValidatorFailure |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
