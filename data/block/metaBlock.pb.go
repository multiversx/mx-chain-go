...
type Economics struct {
	...
	CommunityAddress       []byte        `protobuf:"bytes,6,opt,name=CommunityAddress,proto3" json:"CommunityAddress,omitempty"`
	NodePrice              *math_big.Int `protobuf:"bytes,7,opt,name=NodePrice,proto3,casttypewith=math/big.Int;github.com/ElrondNetwork/elrond-go/data.BigIntCaster" json:"NodePrice,omitempty"`
	PrevEpochStartRound    uint64        `protobuf:"varint,8,opt,name=PrevEpochStartRound,proto3" json:"PrevEpochStartRound,omitempty"`
	PrevEpochStartHash     []byte        `protobuf:"bytes,9,opt,name=PrevEpochStartHash,proto3" json:"PrevEpochStartHash,omitempty"`
}
...
func (m *Economics) GetCommunityAddress() []byte {
	if m != nil {
...
var fileDescriptor_87b91ab531130b2b = []byte{
	...
	,
}
...
func (this *Economics) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.CommunityAddress, that1.CommunityAddress) {
		return false
	}
	{
		__caster := &github_com_ElrondNetwork_elrond_go_data.BigIntCaster{}
...
func (this *Economics) GoString() string {
	...
	s = append(s, "CommunityAddress: "+fmt.Sprintf("%#v", this.CommunityAddress)+",\n")
...
func (m *Economics) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CommunityAddress) > 0 {
		...
		i = encodeVarintMetaBlock(dAtA, i, uint64(len(m.CommunityAddress)))
		i--
		dAtA[i] = 0x32
	}
	{
...
func (this *Economics) String() string {
	...
	s := strings.Join([]string{`&Economics{`,
		...
		`CommunityAddress:` + fmt.Sprintf("%v", this.CommunityAddress) + `,`,
...
func (m *Economics) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.CommunityAddress = append(m.CommunityAddress[:0], dAtA[iNdEx:postIndex]...)
			if m.CommunityAddress == nil {
				m.CommunityAddress = []byte{}
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
