...
func (inf *initialNodeFacade) GetSelectedTransactions(request *common.TransactionsSelectionSimulationRequest) (*common.TransactionsSelectionSimulationResult, error) {
	return nil, errNodeStarting
}
