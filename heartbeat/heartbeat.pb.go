...
type HeartbeatV2 struct {
	...
	ArrivalTimestamp   int64  `protobuf:"varint,9,opt,name=ArrivalTimestamp,proto3" json:"ArrivalTimestamp,omitempty"`
}
...
func (m *HeartbeatV2) GetArrivalTimestamp() int64 {
	if m != nil {
...
func (m *Payload) GetTimestampMicro() int64 {
	if m != nil {
...
var fileDescriptor_3c667767fb9826a9 = []byte{
	...
	,
}
...
func (this *HeartbeatV2) Equal(that interface{}) bool {
	...
	if this.ArrivalTimestamp != that1.ArrivalTimestamp {
		return false
	}
	return true
}
...
func (this *Payload) Equal(that interface{}) bool {
	...
	if this.TimestampMicro != that1.TimestampMicro {
		return false
	}
	return true
}
func (this *HeartbeatV2) GoString() string {
	...
	s = append(s, "ArrivalTimestamp: "+fmt.Sprintf("%#v", this.ArrivalTimestamp)+",\n")
	s = append(s, "}")
...
func (this *Payload) GoString() string {
	...
	s = append(s, "TimestampMicro: "+fmt.Sprintf("%#v", this.TimestampMicro)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *HeartbeatV2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ArrivalTimestamp != 0 {
		i = encodeVarintHeartbeat(dAtA, i, uint64(m.ArrivalTimestamp))
		i--
		dAtA[i] = 0x48
	}
...
func (m *Payload) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TimestampMicro != 0 {
		i = encodeVarintHeartbeat(dAtA, i, uint64(m.TimestampMicro))
		i--
		dAtA[i] = 0x18
	}
...
func (m *HeartbeatV2) Size() (n int) {
	...
	if m.ArrivalTimestamp != 0 {
		n += 1 + sovHeartbeat(uint64(m.ArrivalTimestamp))
	}
	return n
}
...
func (m *Payload) Size() (n int) {
	...
	if m.TimestampMicro != 0 {
		n += 1 + sovHeartbeat(uint64(m.TimestampMicro))
	}
	return n
}
...
func (this *HeartbeatV2) String() string {
	...
	s := strings.Join([]string{`&HeartbeatV2{`,
		...
		`ArrivalTimestamp:` + fmt.Sprintf("%v", this.ArrivalTimestamp) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *Payload) String() string {
	...
	s := strings.Join([]string{`&Payload{`,
		...
		`TimestampMicro:` + fmt.Sprintf("%v", this.TimestampMicro) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *HeartbeatV2) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ArrivalTimestamp", wireType)
			}
			m.ArrivalTimestamp = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowHeartbeat
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ArrivalTimestamp |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
