...
func TestEnableEpochsHandler_IsFlagEnabled(t *testing.T) {
	...
	require.True(t, handler.IsFlagEnabled(common.MigrateCodeLeafFlag))
}
...
func TestEnableEpochsHandler_GetActivationEpoch(t *testing.T) {
	...
	require.Equal(t, cfg.MigrateCodeLeafEnableEpoch, handler.GetActivationEpoch(common.MigrateCodeLeafFlag))
}
