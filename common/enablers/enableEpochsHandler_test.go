...
func createEnableEpochsConfig() config.EnableEpochs {
	return config.EnableEpochs{
		...
		EliminateGasPriceModifierEnableEpoch:                     118,
	}
}
...
func TestEnableEpochsHandler_IsFlagEnabled(t *testing.T) {
	...
	require.True(t, handler.IsFlagEnabled(common.DynamicESDTFlag))
	require.True(t, handler.IsFlagEnabled(common.EliminateGasPriceModifierFlag))
}
...
func TestEnableEpochsHandler_GetActivationEpoch(t *testing.T) {
	...
	require.Equal(t, cfg.EliminateGasPriceModifierEnableEpoch, handler.GetActivationEpoch(common.EliminateGasPriceModifierFlag))
}
