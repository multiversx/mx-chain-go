...
func createEnableEpochsConfig() config.EnableEpochs {
	return config.EnableEpochs{
		...
		UseGasBoundedShouldFailExecutionEnableEpoch:              107,
		HashForInnerTransactionEnableEpoch:                       108,
	}
}
...
func TestEnableEpochsHandler_IsFlagEnabled(t *testing.T) {
	...
	require.True(t, handler.IsFlagEnabled(common.HashForInnerTransactionFlag))
}
...
func TestEnableEpochsHandler_GetActivationEpoch(t *testing.T) {
	...
	require.Equal(t, cfg.HashForInnerTransactionEnableEpoch, handler.GetActivationEpoch(common.HashForInnerTransactionFlag))
}
