...
func (handler *enableEpochsHandler) EpochConfirmed(epoch uint32, _ uint64) {
	...
	handler.setFlagValue(epoch >= handler.enableEpochsConfig.ConsensusModelV2EnableEpoch, handler.consensusModelV2Flag, "consensusModelV2Flag", epoch, handler.enableEpochsConfig.ConsensusModelV2EnableEpoch)
}
