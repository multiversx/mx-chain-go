...
func (handler *enableEpochsHandler) EpochConfirmed(epoch uint32, _ uint64) {
	...
	handler.setFlagValue(epoch >= handler.enableEpochsConfig.StakeLimitsEnableEpoch, handler.stakeLimitsFlag, "stakeLimitsFlag", epoch, handler.enableEpochsConfig.StakeLimitsEnableEpoch)
	handler.setFlagValue(epoch == handler.enableEpochsConfig.StakingV4Step1EnableEpoch, handler.stakingV4Step1Flag, "stakingV4Step1Flag", epoch, handler.enableEpochsConfig.StakingV4Step1EnableEpoch)
	handler.setFlagValue(epoch >= handler.enableEpochsConfig.StakingV4Step2EnableEpoch, handler.stakingV4Step2Flag, "stakingV4Step2Flag", epoch, handler.enableEpochsConfig.StakingV4Step2EnableEpoch)
	handler.setFlagValue(epoch >= handler.enableEpochsConfig.StakingV4Step3EnableEpoch, handler.stakingV4Step3Flag, "stakingV4Step3Flag", epoch, handler.enableEpochsConfig.StakingV4Step3EnableEpoch)
	handler.setFlagValue(epoch < handler.enableEpochsConfig.StakingV4Step1EnableEpoch, handler.stakingQueueEnabledFlag, "stakingQueueEnabledFlag", epoch, handler.enableEpochsConfig.StakingV4Step1EnableEpoch)
	handler.setFlagValue(epoch >= handler.enableEpochsConfig.StakingV4Step1EnableEpoch, handler.stakingV4StartedFlag, "stakingV4StartedFlag", epoch, handler.enableEpochsConfig.StakingV4Step1EnableEpoch)
}
