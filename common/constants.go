...
const (
	...
	// MetricHashForInnerTransactionEnableEpoch represents the epoch when the hash for inner transactions of relayed v3 is enabled
	MetricHashForInnerTransactionEnableEpoch = "erd_hash_for_inner_transaction_enable_epoch"
...
const (
	...
	HashForInnerTransactionFlag                        core.EnableEpochFlag = "HashForInnerTransactionFlag"
