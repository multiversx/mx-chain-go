...
[EnableEpochs]
    ...
    # ESDTNFTCreateOnMultiShard represents the epoch when esdt nft creation on multiple shards is enabled
    ESDTNFTCreateOnMultiShard = 32
