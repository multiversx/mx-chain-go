...
// ErrChainParametersForEpoch signals that there is an err in chain parameters for epoch
var ErrChainParametersForEpoch = errors.New("err in chain parameters for epoch")
