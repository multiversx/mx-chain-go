...
// ErrInvalidChainParametersForEpoch signals that there is an err in chain parameters for epoch
var ErrInvalidChainParametersForEpoch = errors.New("err in chain parameters for epoch")
