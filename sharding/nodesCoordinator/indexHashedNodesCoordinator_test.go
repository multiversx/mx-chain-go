...
func TestNodesCoordinator_CustomConsensusGroupSize(t *testing.T) {
	...
	fmt.Println(ihnc.nodesConfig[4])

	fmt.Println(ihnc.ConsensusGroupSizeForShardAndEpoch(0, 4))
	fmt.Println(ihnc.ConsensusGroupSizeForShardAndEpoch(common.MetachainShardId, 4))
}
