...
func NewIndexHashedNodesCoordinator(arguments ArgNodesCoordinator) (*indexHashedNodesCoordinator, error) {
	...
	if currentConfig == nil {
		debug.PrintStack()
		return nil, fmt.Errorf("%w v2 epoch=%v", ErrEpochNodesConfigDoesNotExist, arguments.Epoch)
	}
...
func (ihnc *indexHashedNodesCoordinator) ComputeConsensusGroup(
	...
	if validators != nil {
		log.Error("REMOVE_ME - used cached validators", "round", round, "shard", shardID, "epoch", epoch, "rand", randomness)
