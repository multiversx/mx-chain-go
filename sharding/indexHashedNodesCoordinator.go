...
// GetAllEligibleValidatorsPublicKeys will return all eligible validators public keys for all shards
...
// GetAllWaitingValidatorsPublicKeys will return all waiting list validators public keys for all shards
