...
func (sp *shardProcessor) RemoveMetaBlockFromPool(blockBody block.Body, blockChain data.ChainHandler) error {
	return sp.removeMetaBlockFromPool(blockBody, blockChain)
}
