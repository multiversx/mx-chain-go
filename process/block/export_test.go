...
func (bp *blockProcessor) RequestTransactionFromNetwork(body []*block.MiniBlock) int {
...
func (bp *blockProcessor) DisplayLogInfo(header *block.Header, txBlock []*block.MiniBlock, headerHash []byte) {
