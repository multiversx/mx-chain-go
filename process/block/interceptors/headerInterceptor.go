...
//func (hi *HeaderInterceptor) ParseReceivedMessage(message p2p.MessageP2P) (*interceptedBlocks.InterceptedHeader, error) {
...
//	}
//
//	hdrIntercepted := interceptedBlocks.NewInterceptedHeader(hi.multiSigVerifier, hi.chronologyValidator)
...
//func (hi *HeaderInterceptor) checkHeaderForCurrentShard(interceptedHdr *interceptedBlocks.InterceptedHeader) bool {
...
//}
//
//func (hi *HeaderInterceptor) processHeader(hdrIntercepted *interceptedBlocks.InterceptedHeader) {
