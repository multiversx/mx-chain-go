...
func (s *shardBlockProcessorFactory) CreateBlockProcessor(argumentsBaseProcessor ArgBaseProcessor, _ ArgMetaProcessor) (process.DebuggerBlockProcessor, error) {
