...
type MiniBlocksInMeta struct {
	...
	IsFullyProcessed       []bool   `protobuf:"varint,3,rep,packed,name=IsFullyProcessed,proto3" json:"IsFullyProcessed,omitempty"`
	IndexOfLastTxProcessed []uint32 `protobuf:"varint,4,rep,packed,name=IndexOfLastTxProcessed,proto3" json:"IndexOfLastTxProcessed,omitempty"`
}
...
func (m *MiniBlocksInMeta) GetIsFullyProcessed() []bool {
	if m != nil {
		return m.IsFullyProcessed
	}
	return nil
}

func (m *MiniBlocksInMeta) GetIndexOfLastTxProcessed() []uint32 {
	if m != nil {
...
var fileDescriptor_cd9e3de0f7706101 = []byte{
	...
	,
}
...
func (this *MiniBlocksInMeta) Equal(that interface{}) bool {
	...
	if len(this.IsFullyProcessed) != len(that1.IsFullyProcessed) {
		return false
	}
	for i := range this.IsFullyProcessed {
		if this.IsFullyProcessed[i] != that1.IsFullyProcessed[i] {
			return false
		}
	}
...
func (m *MiniBlocksInMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IndexOfLastTxProcessed) > 0 {
		...
		var j1 int
		for _, num := range m.IndexOfLastTxProcessed {
			for num >= 1<<7 {
	...
	if len(m.IsFullyProcessed) > 0 {
		for iNdEx := len(m.IsFullyProcessed) - 1; iNdEx >= 0; iNdEx-- {
			i--
			if m.IsFullyProcessed[iNdEx] {
				dAtA[i] = 1
			} else {
				dAtA[i] = 0
			}
		}
		i = encodeVarintBootstrapData(dAtA, i, uint64(len(m.IsFullyProcessed)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *MiniBlocksInMeta) Size() (n int) {
	...
	if len(m.IsFullyProcessed) > 0 {
		n += 1 + sovBootstrapData(uint64(len(m.IsFullyProcessed))) + len(m.IsFullyProcessed)*1
	}
	if len(m.IndexOfLastTxProcessed) > 0 {
		l = 0
...
func (this *MiniBlocksInMeta) String() string {
	...
	s := strings.Join([]string{`&MiniBlocksInMeta{`,
		...
		`IsFullyProcessed:` + fmt.Sprintf("%v", this.IsFullyProcessed) + `,`,
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				m.IsFullyProcessed = append(m.IsFullyProcessed, bool(v != 0))
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.IsFullyProcessed) == 0 {
					m.IsFullyProcessed = make([]bool, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field IsFullyProcessed", wireType)
			}
		case 4:
			if wireType == 0 {
				var v uint32
				...
				if elementCount != 0 && len(m.IndexOfLastTxProcessed) == 0 {
					m.IndexOfLastTxProcessed = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
