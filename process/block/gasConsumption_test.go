...
func TestGasConsumption_DecreaseBlockLimit(t *testing.T) {
	t.Parallel()
	...
	for i := 0; i < 100; i++ {
		gc.DecreaseBlockLimit()
	}

	// mini block limit should be at lowest, 10% of the half configured 400 => 20 (max 2 txs)
