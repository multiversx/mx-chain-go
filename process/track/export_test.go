...
func (bp *blockProcessor) RequestHeadersIfNothingNewIsReceived(lastNotarizedHeader data.HeaderHandler, latestValidHeader data.HeaderHandler, highestRoundInReceivedHeaders uint64) {
	bp.requestHeadersIfNothingNewIsReceived(lastNotarizedHeader, latestValidHeader, highestRoundInReceivedHeaders)
}
