...
type ListIndexUpdater struct {
	updateListAndIndex func(pubKey string, shardID uint32, list string, index int32) error
}

// UpdateListAndIndex will update the list and the index for a given peer
func (liu *ListIndexUpdater) UpdateListAndIndex(pubKey string, shardID uint32, list string, index int32) error {
