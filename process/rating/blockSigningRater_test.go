...
func TestBlockSigningRater_NewBlockSigningRaterWithCorrectValueShouldWork(t *testing.T) {
	...
	assert.Equal(t, uint32(testValue+ratingsData.ShardChainRatingsStepHandler().ValidatorIncreaseRatingStep()), bsr.ComputeIncreaseValidator(uint32(testValue)))
	assert.Equal(t, uint32(testValue+ratingsData.ShardChainRatingsStepHandler().ValidatorDecreaseRatingStep()), bsr.ComputeDecreaseValidator(uint32(testValue)))
	assert.Equal(t, uint32(testValue+ratingsData.ShardChainRatingsStepHandler().ProposerIncreaseRatingStep()), bsr.ComputeIncreaseProposer(uint32(testValue)))
	assert.Equal(t, uint32(testValue+ratingsData.ShardChainRatingsStepHandler().ProposerDecreaseRatingStep()), bsr.ComputeDecreaseProposer(uint32(testValue)))
