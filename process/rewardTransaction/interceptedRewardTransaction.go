...
// GetInterceptorUsedGuardianPubKey returns nil, as the reward transactions are generated by the metaChain and have no guardian
func (inRTx *InterceptedRewardTransaction) GetInterceptorUsedGuardianPubKey() []byte {
	return nil
}

// SetInterceptorUsedGuardianPubKey returns error as the rewards transactions are generated by metaChain and do not have guardian
func (inRTx *InterceptedRewardTransaction) SetInterceptorUsedGuardianPubKey([]byte) error {
