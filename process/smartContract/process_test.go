...
func createMockSmartContractProcessorArguments() ArgsNewSmartContractProcessor {
	...
	gasSchedule[common.VMAPICost] = make(map[string]uint64)
	gasSchedule[common.VMAPICost][common.AsyncCallStepField] = 1000
	gasSchedule[common.VMAPICost][common.AsyncCallbackGasLockField] = 3000
