...
// ErrInvalidVersionFoundGaps signals that the version element is not accepted because there are gaps/interlace between the previous versions
var ErrInvalidVersionFoundGaps = errors.New("invalid version provided (gaps or interlace)")
