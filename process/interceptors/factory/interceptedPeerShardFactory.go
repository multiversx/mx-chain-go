...
import (
	...
	p "github.com/multiversx/mx-chain-go/p2p"
...
func (ipsf *interceptedPeerShardFactory) Create(buff []byte, _ core.PeerID, _ p.BroadcastMethod) (process.InterceptedData, error) {
