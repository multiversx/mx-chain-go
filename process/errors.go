...
// ErrHigherGasLimitRequiredInBlock signals that a higher gas limit is required in block
var ErrHigherGasLimitRequiredInBlock = errors.New("higher gas limit required in block")
