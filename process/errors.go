...
// ErrNilPreProcessorsFactoryHandler signals that a nil pre processors factory handler has been provided
var ErrNilPreProcessorsFactoryHandler = errors.New("nil pre processors factory handler")
