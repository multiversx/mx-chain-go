...
func (bst *blockSizeThrottle) getMaxItemsWhenSucceed(lastActionMaxItems uint32) uint32 {
	...
	increasedNoOfItems := uint32(core.Max(1, int32(float32(noOfMaxItemsUsedWithoutSucceed-lastActionMaxItems)*jumpAboveFactor)))
...
func (bst *blockSizeThrottle) getMaxItemsWhenNotSucceed(lastActionMaxItems uint32) uint32 {
	...
	decreasedNoOfItems := uint32(core.Max(1, int32(float32(lastActionMaxItems-noOfMaxItemsUsedWithSucceed)*jumpBelowFactor)))
