...
func (qfp *quotaFloodPreventer) AccumulateGlobal(identifier string, size uint64) error {
...
func (qfp *quotaFloodPreventer) Accumulate(identifier string, size uint64) error {
	qfp.mutOperation.Lock()
