...
type PreProcessorMock struct {
	...
	ProcessBlockTransactionsCalled        func(body *block.Body, haveTime func() bool, scheduledMode bool) error
	...
	ProcessMiniBlockCalled                func(miniBlock *block.MiniBlock, haveTime func() bool, getNumOfCrossInterMbsAndTxs func() (int, int), scheduledMode bool) ([][]byte, int, error)
...
func (ppm *PreProcessorMock) ProcessBlockTransactions(body *block.Body, haveTime func() bool, scheduledMode bool) error {
	if ppm.ProcessBlockTransactionsCalled == nil {
		return nil
	}
	return ppm.ProcessBlockTransactionsCalled(body, haveTime, scheduledMode)
}
...
// ProcessMiniBlock -
func (ppm *PreProcessorMock) ProcessMiniBlock(miniBlock *block.MiniBlock, haveTime func() bool, getNumOfCrossInterMbsAndTxs func() (int, int), scheduledMode bool) ([][]byte, int, error) {
	if ppm.ProcessMiniBlockCalled == nil {
		return nil, 0, nil
	}
	return ppm.ProcessMiniBlockCalled(miniBlock, haveTime, getNumOfCrossInterMbsAndTxs, scheduledMode)
}
