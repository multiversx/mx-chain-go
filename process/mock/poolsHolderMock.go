...
func NewPoolsHolderMock() *PoolsHolderMock {
	phf := &PoolsHolderMock{}
	phf.transactions = txpool.NewShardedTxPool(storageUnit.CacheConfig{Size: 10000, Shards: 16})
...
func (phm *PoolsHolderMock) Transactions() dataRetriever.TxPool {
...
func (phm *PoolsHolderMock) SetTransactions(transactions dataRetriever.TxPool) {
