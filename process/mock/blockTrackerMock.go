...
func (btm *BlockTrackerMock) SetNumPendingMiniBlocks(shardID uint32, numPendingMiniBlocks uint32) {
	if btm.SetNumPendingMiniBlocksCalled != nil {
		btm.SetNumPendingMiniBlocksCalled(shardID, numPendingMiniBlocks)
	}
}
