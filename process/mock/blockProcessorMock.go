...
type BlockProcessorMock struct {
	...
	CreateEmptyBlockBodyCalled    func(shardId uint32, round int32) block.Body
...
func (blProcMock BlockProcessorMock) CreateEmptyBlockBody(shardId uint32, round int32) block.Body {
