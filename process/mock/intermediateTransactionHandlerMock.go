...
func (ith *IntermediateTransactionHandlerMock) GetAllCurrentUsedTxs() map[string]data.TransactionHandler {
	if ith.GetAllCurrentUsedTxsCalled != nil {
		return ith.GetAllCurrentUsedTxsCalled()
	}
	return nil
}
