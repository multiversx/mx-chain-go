...
func (ir *interceptorsResolvers) createTxResolver() error {
	...
	identifier := TransactionTopic + ir.shardCoordinator.CommunicationIdentifier(ir.shardCoordinator.SelfId())
...
func (ir *interceptorsResolvers) createHdrResolver() error {
	//TODO temporary, will be refactored in EN-1104
	identifier := HeadersTopic + ir.shardCoordinator.CommunicationIdentifier(ir.shardCoordinator.SelfId())
...
func (ir *interceptorsResolvers) createTxBlockBodyResolver() error {
	//TODO temporary, will be refactored in EN-1104
	identifier := MiniBlocksTopic + ir.shardCoordinator.CommunicationIdentifier(ir.shardCoordinator.SelfId())
...
func (ir *interceptorsResolvers) createPeerChBlockBodyResolver() error {
	//TODO temporary, will be refactored in EN-1104
	identifier := PeerChBodyTopic + ir.shardCoordinator.CommunicationIdentifier(ir.shardCoordinator.SelfId())
