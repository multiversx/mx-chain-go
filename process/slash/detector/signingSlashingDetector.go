...
func (hsd *SigningSlashingDetector) VerifyData(data process.InterceptedData) slash.SlashingDetectorResultHandler {
	...
	return slash.NewSlashingDetectorResult("message", data, nil)
}
