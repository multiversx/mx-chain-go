...
func NewEconomicsData(args ArgsNewEconomicsData) (*economicsData, error) {
	...
	log.Debug("enable epoch for penalized too much gas", "epoch", ed.penalizedTooMuchGasEnableEpoch)
	log.Debug("enable epoch for gas price modifier", "epoch", ed.gasPriceModifier)
