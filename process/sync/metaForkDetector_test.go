...
func TestNewMetaForkDetector_NilChainParametersHandlerShouldErr(t *testing.T) {
	t.Parallel()
...
func TestMetaForkDetector_AddHeaderNilHeaderShouldErr(t *testing.T) {
	...
	bfd, _ := sync.NewMetaForkDetector(roundHandlerMock, &testscommon.TimeCacheStub{}, &mock.BlockTrackerMock{}, getChainParams(), 0)
