...
// ValidatorsWeights -
func (n *nodesCoordinator) ValidatorsWeights(validators []core.Validator) ([]uint32, error) {
	return make([]uint32, len(validators)), nil
}

// ComputeAdditionalLeaving -
func (n *nodesCoordinator) ComputeAdditionalLeaving(_ []*state.ShardValidatorInfo) (map[uint32][]core.Validator, error) {
	return nil, nil
}
...
func (n *nodesCoordinator) ComputeConsensusGroup(_ []byte, _ uint64, _ uint32, _ uint32) (validatorsGroup []core.Validator, err error) {
	return nil, nil
}

// GetValidatorWithPublicKey -
func (n *nodesCoordinator) GetValidatorWithPublicKey(_ []byte) (validator core.Validator, shardId uint32, err error) {
	return nil, 0, nil
}
