...
func (f *FacadeStub) GetSelectedTransactions(request *common.TransactionsSelectionSimulationRequest) (*common.TransactionsSelectionSimulationResult, error) {
	if f.GetSelectedTransactionsCalled != nil {
		return f.GetSelectedTransactionsCalled(request)
	}
