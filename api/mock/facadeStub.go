...
func (f *FacadeStub) GetTransactionsForSender(sender string) (*common.TransactionsForSenderApiResponse, error) {
	if f.GetTransactionsForSenderCalled != nil {
		return f.GetTransactionsForSenderCalled(sender)
	}
