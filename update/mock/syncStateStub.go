...
func (sss *SyncStateStub) GetEpochStartMetaBlock() (data.HeaderHandler, error) {
...
func (sss *SyncStateStub) GetUnFinishedMetaBlocks() (map[string]data.HeaderHandler, error) {
