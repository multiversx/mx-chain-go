...
func TestNewStateImport(t *testing.T) {
	...
	trieStorageManagers[factory.UserAccountTrie] = &storageManager.StorageManagerStub{}
	tests := []struct {
		name    string
...
func TestImportAll(t *testing.T) {
	...
	trieStorageManagers := make(map[string]common.StorageManager)
	trieStorageManagers[factory.UserAccountTrie] = &storageManager.StorageManagerStub{}
	trieStorageManagers[factory.PeerAccountTrie] = &storageManager.StorageManagerStub{}
