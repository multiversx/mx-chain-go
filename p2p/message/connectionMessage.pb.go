...
func (*ShardValidatorInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_d067d1ce36ecd889, []int{0}
}
...
var fileDescriptor_d067d1ce36ecd889 = []byte{
	// 203 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x4f, 0xce, 0xcf, 0xcb,
	0x4b, 0x4d, 0x2e, 0xc9, 0xcc, 0xcf, 0xf3, 0x4d, 0x2d, 0x2e, 0x4e, 0x4c, 0x4f, 0xd5, 0x2b, 0x28,
	0xca, 0x2f, 0xc9, 0x17, 0x62, 0x05, 0x53, 0x52, 0xba, 0xe9, 0x99, 0x25, 0x19, 0xa5, 0x49, 0x7a,
	0xc9, 0xf9, 0xb9, 0xfa, 0xe9, 0xf9, 0xe9, 0xf9, 0xfa, 0x60, 0xe1, 0xa4, 0xd2, 0x34, 0x30, 0x0f,
	0xcc, 0x01, 0xb3, 0x20, 0xba, 0x94, 0xac, 0xb9, 0x84, 0x82, 0x33, 0x12, 0x8b, 0x52, 0xc2, 0x12,
	0x73, 0x32, 0x53, 0x12, 0x4b, 0xf2, 0x8b, 0x3c, 0xf3, 0xd2, 0xf2, 0x85, 0x54, 0xb9, 0xd8, 0xc1,
	0xa2, 0x9e, 0x29, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0xbc, 0x4e, 0xdc, 0xaf, 0xee, 0xc9, 0xb3, 0x17,
	...
	0x96, 0x63, 0x88, 0x62, 0xcf, 0x85, 0xb8, 0x3d, 0x89, 0x0d, 0xec, 0x0c, 0x63, 0x40, 0x00, 0x00,
	0x00, 0xff, 0xff, 0xc5, 0x23, 0x6b, 0xf7, 0xd7, 0x00, 0x00, 0x00,
}
...
func (this *ShardValidatorInfo) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&message.ShardValidatorInfo{")
	s = append(s, "ShardId: "+fmt.Sprintf("%#v", this.ShardId)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func valueToGoStringConnectionMessage(v interface{}, typ string) string {
...
func (m *ShardValidatorInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ShardId != 0 {
		i = encodeVarintConnectionMessage(dAtA, i, uint64(m.ShardId))
		i--
		dAtA[i] = 0x8
	}
...
func encodeVarintConnectionMessage(dAtA []byte, offset int, v uint64) int {
	offset -= sovConnectionMessage(v)
	base := offset
	for v >= 1<<7 {
...
func (m *ShardValidatorInfo) Size() (n int) {
	...
	_ = l
	if m.ShardId != 0 {
		n += 1 + sovConnectionMessage(uint64(m.ShardId))
	}
	return n
}

func sovConnectionMessage(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozConnectionMessage(x uint64) (n int) {
	return sovConnectionMessage(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func valueToStringConnectionMessage(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *ShardValidatorInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowConnectionMessage
			}
			if iNdEx >= l {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipConnectionMessage(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
				return ErrInvalidLengthConnectionMessage
			}
			if (iNdEx + skippy) < 0 {
				return ErrInvalidLengthConnectionMessage
			}
...
func skipConnectionMessage(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowConnectionMessage
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthConnectionMessage
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupConnectionMessage
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthConnectionMessage        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowConnectionMessage          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupConnectionMessage = fmt.Errorf("proto: unexpected end of group")
)
