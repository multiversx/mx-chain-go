...
//	time.Sleep(time.Second)
//
//	assert.Equal(t, 1, len((*cn.Mes).GetConns()))
//}
//
...
//	}
//
//	cn.OnNeedToConnectToOtherPeer = func(cn *p2p_old.ConnNotifier, pid peer.ID) error {
...
//	}
//
//	cn.OnGetKnownPeers = func(sender *p2p_old.ConnNotifier) []peer.ID {
