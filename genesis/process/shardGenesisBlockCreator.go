...
func createProcessorsForShardGenesisBlock(arg ArgsGenesisBlockCreator, enableEpochsConfig config.EnableEpochs) (*genesisProcessors, error) {
	...
	argsNewTxProcessor := transaction.ArgsNewTxProcessor{
		...
		ScrForwarder:                          scForwarder,
		EpochNotifier:                         epochNotifier,
		RelayedTxEnableEpoch:                  enableEpochsConfig.RelayedTransactionsEnableEpoch,
		PenalizedTooMuchGasEnableEpoch:        enableEpochsConfig.PenalizedTooMuchGasEnableEpoch,
		MetaProtectionEnableEpoch:             enableEpochsConfig.MetaProtectionEnableEpoch,
		RelayedTxV2EnableEpoch:                enableEpochsConfig.RelayedTransactionsV2EnableEpoch,
		AddFailedRelayedToInvalidDisableEpoch: enableEpochsConfig.AddFailedRelayedTxToInvalidMBsDisableEpoch,
	}
