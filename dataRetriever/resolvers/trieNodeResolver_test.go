...
//TODO(this PR) fix or remove this test
//func TestTrieNodeResolver_ResolveMultipleHashesSmallTrieNodeAndLargeTrieNode(t *testing.T) {
//	t.Parallel()
//
//	arg := createMockArgTrieNodeResolver()
//	smallTrieNodeHash := []byte("smallTrieNodeHash")
//	smallTrieNodeBytes := []byte("a few bytes")
//	largeTrieNodeHash := []byte("largeTrieNodeHash")
//	largeTrieNodeBytes := bytes.Repeat([]byte("a"), core.MaxBufferSizeToSendTrieNodes)
//
//	arg.TrieDataGetter = &trieMock.TrieStub{
//		GetSerializedNodeCalled: func(buff []byte) ([]byte, error) {
//			if bytes.Equal(buff, smallTrieNodeHash){
//				return smallTrieNodeBytes, nil
//			}
//			if bytes.Equal(buff, largeTrieNodeHash){
//				return largeTrieNodeBytes, nil
//			}
//			return nil, errors.New("unexpected key")
//		},
//		GetSerializedNodesCalled: func(buff []byte, u uint64) ([][]byte, uint64, error) {
//			if bytes.Equal(buff, smallTrieNodeHash){
//				return smallTrieNodeBytes, nil
//			}
//		},
...
//	arg.SenderResolver = &mock.TopicResolverSenderStub{
//		SendCalled: func(buff []byte, peer core.PeerID) error {
//			assert.True(t, len(buff) < core.MaxBufferSizeToSendTrieNodes)
//			return nil
//		},
//	}
//	tnRes, _ := resolvers.NewTrieNodeResolver(arg)
//	b := &batch.Batch{
//		Data: [][]byte{largeTrieNodeHash, smallTrieNodeHash},
//	}
//	hashes, err := arg.Marshalizer.Marshal(b)
//	require.Nil(t, err)
//
//	err = tnRes.ResolveMultipleHashes(hashes, &mock.P2PMessageMock{})
//	require.Nil(t, err)
//}
