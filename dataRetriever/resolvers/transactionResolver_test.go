...
func TestTxResolver_ProcessReceivedMessageCanProcessMessageErrorsShouldErr(t *testing.T) {
	...
	_, err := txRes.ProcessReceivedMessage(&p2pmocks.P2PMessageMock{}, connectedPeerId, &p2pmocks.MessengerStub{})
...
func TestTxResolver_ProcessReceivedMessageNilMessageShouldErr(t *testing.T) {
	...
	_, err := txRes.ProcessReceivedMessage(nil, connectedPeerId, &p2pmocks.MessengerStub{})
...
func TestTxResolver_ProcessReceivedMessageWrongTypeShouldErr(t *testing.T) {
	...
	_, err := txRes.ProcessReceivedMessage(msg, connectedPeerId, &p2pmocks.MessengerStub{})
