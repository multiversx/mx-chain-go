...
const (
	...
	// EpochStartMetaBlockUnit is the epochstart metablocks storage unit identifier
	EpochStartMetaBlockUnit UnitType = 25
...
func (ut UnitType) String() string {
	...
	case EpochStartMetaBlockUnit:
		return "EpochStartMetaBlockUnit"
	}
