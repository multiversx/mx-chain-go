...
// VerifyAggregatedSig -
func (stub *MultiSignerStub) VerifyAggregatedSig(pubKeysSigners []crypto.PublicKey, message []byte, aggSig []byte) error {
...
// AggregateSigs -
func (stub *MultiSignerStub) AggregateSigs(pubKeysSigners []crypto.PublicKey, signatures [][]byte) ([]byte, error) {
