...
// Rewind -
func (e *ExecutionTrackerStub) Rewind(lastNotarizedResult data.BaseExecutionResultHandler, chainTipNonce uint64) {
	if e.RewindCalled != nil {
		e.RewindCalled(lastNotarizedResult, chainTipNonce)
	}
}
