...
type AccountsStub struct {
	...
	GetAllLeavesCalled            func(leavesChannels common.AllLeavesChannels, ctx context.Context, rootHash []byte) error
...
// GetAllLeaves -
func (as *AccountsStub) GetAllLeaves(leavesChannels common.AllLeavesChannels, ctx context.Context, rootHash []byte) error {
