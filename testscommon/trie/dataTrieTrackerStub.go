...
type DataTrieTrackerStub struct {
	...
	SaveDirtyDataCalled         func(trie common.Trie) ([]stateChanges.DataTrieChange, []core.TrieData, error)
...
// SaveDirtyData -
func (dtts *DataTrieTrackerStub) SaveDirtyData(mainTrie common.Trie) ([]stateChanges.DataTrieChange, []core.TrieData, error) {
