...
func (builder *txDataBuilder) MultiTransferESDTNFT(transfers []*vmcommon.ESDTTransfer) *txDataBuilder {
	txBuilder := builder.Func(core.BuiltInFunctionMultiESDTNFTTransfer).Int(len(transfers))
