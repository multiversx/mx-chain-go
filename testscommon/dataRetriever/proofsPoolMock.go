...
// GetProofByHash -
func (p *ProofsPoolMock) GetProofByHash(headerHash []byte) (data.HeaderProofHandler, error) {
	if p.GetProofByHashCalled != nil {
		return p.GetProofByHashCalled(headerHash)
	}
