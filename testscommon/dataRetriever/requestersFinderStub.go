...
type RequestersFinderStub struct {
	...
	AddMultipleCalled             func(keys []string, vals []dataRetriever.Requester) error
...
// AddMultiple -
func (stub *RequestersFinderStub) AddMultiple(keys []string, vals []dataRetriever.Requester) error {
	if stub.AddMultipleCalled != nil {
		return stub.AddMultipleCalled(keys, vals)
	}
	return nil
}
