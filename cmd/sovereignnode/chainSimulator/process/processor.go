...
type sovereignBlocksCreator struct {
	nodeHandler process.NodeHandler
}

// NewSovereignBlocksCreator will create a new instance of sovereign blocksCreator
func NewSovereignBlocksCreator(nodeHandler process.NodeHandler) (*sovereignBlocksCreator, error) {
	if check.IfNil(nodeHandler) {
		return nil, process.ErrNilNodeHandler
	}

	return &sovereignBlocksCreator{
		nodeHandler: nodeHandler,
	}, nil
}

// IncrementRound will increment the current round
func (creator *sovereignBlocksCreator) IncrementRound() {
...
func (creator *sovereignBlocksCreator) CreateNewBlock() error {
...
func (creator *sovereignBlocksCreator) getPreviousHeaderData() (nonce, round uint64, prevHash, prevRandSeed []byte, epoch uint32) {
...
func (creator *sovereignBlocksCreator) createLeaderSignature(header data.HeaderHandler, blsKeyBytes []byte) ([]byte, error) {
...
func (creator *sovereignBlocksCreator) IsInterfaceNil() bool {
	return creator == nil
}
