...
func initMetrics(
	...
	appStatusHandler.SetUInt64Value(core.MetricCountConsensus, uint64(0))
	appStatusHandler.SetUInt64Value(core.MetricCountLeader, uint64(0))
	appStatusHandler.SetUInt64Value(core.MetricCountAcceptedBlocks, uint64(0))
	appStatusHandler.SetUInt64Value(core.MetricNumTxInBlock, uint64(0))
	...
	appStatusHandler.SetStringValue(core.MetricCurrentBlockHash, "")
	appStatusHandler.SetUInt64Value(core.MetricNumProcessedTxs, uint64(0))
	appStatusHandler.SetUInt64Value(core.MetricCurrentRoundTimestamp, uint64(0))
	appStatusHandler.SetUInt64Value(core.MetricHeaderSize, uint64(0))
	appStatusHandler.SetUInt64Value(core.MetricMiniBlocksSize, uint64(0))
	appStatusHandler.SetUInt64Value(core.MetricNumShardHeadersFromPool, uint64(0))
	appStatusHandler.SetUInt64Value(core.MetricNumShardHeadersProcessed, uint64(0))
}
