...
func newShardBlockProcessor(
	...
	argsNewScProcessor := smartContract.ArgsNewSmartContractProcessor{
		...
		RepairScrNonceIncrementEnableEpoch:  config.GeneralSettings.RepairScrNonceIncrementEnableEpoch,
...
func newMetaBlockProcessor(
	...
	argsNewScProcessor := smartContract.ArgsNewSmartContractProcessor{
		...
		RepairScrNonceIncrementEnableEpoch:  generalConfig.GeneralSettings.RepairScrNonceIncrementEnableEpoch,
