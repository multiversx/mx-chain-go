...
type node interface {
	...
	getAllLeavesOnChannel(chan core.KeyValueHolder, common.KeyBuilder, common.TrieLeafParser, common.DBWriteCacher, marshal.Marshalizer, chan struct{}, context.Context) error
