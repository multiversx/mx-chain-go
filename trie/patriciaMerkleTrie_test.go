...
func getDefaultTrieParameters() (common.StorageManager, marshal.Marshalizer, hashing.Hasher, uint, common.StorageAccessType) {
...
func TestNewTrieWithNilTrieStorage(t *testing.T) {
	...
	_, marshalizer, hasher, maxTrieLevelInMemory, priority := getDefaultTrieParameters()
...
func TestNewTrieWithNilMarshalizer(t *testing.T) {
	...
	trieStorage, _, hasher, maxTrieLevelInMemory, priority := getDefaultTrieParameters()
...
func TestNewTrieWithNilHasher(t *testing.T) {
	...
	trieStorage, marshalizer, _, maxTrieLevelInMemory, priority := getDefaultTrieParameters()
...
func TestNewTrieWithInvalidMaxTrieLevelInMemory(t *testing.T) {
	...
	trieStorage, marshalizer, hasher, _, priority := getDefaultTrieParameters()
