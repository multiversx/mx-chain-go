...
// ErrSuffixNotPresentOrOnIncorrectPosition signals that the suffix is not present in the data field or its position is incorrect
var ErrSuffixNotPresentOrOnIncorrectPosition = errors.New("suffix is not present or the position is incorrect")
