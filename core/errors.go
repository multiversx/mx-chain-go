...
// ErrNilGoRoutineProcessor signals that a nil go goroutine processor has been provided
var ErrNilGoRoutineProcessor = errors.New("nil go goroutine processor")
