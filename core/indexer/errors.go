...
// ErrUnknownTransactionHandler signals that an unimplemented transaction handler has been provided
var ErrUnknownTransactionHandler = errors.New("unknown transaction handler")
