...
// SaveAccount will save the provided account
func (di *dataIndexer) SaveAccount(account state.UserAccountHandler) {
	wi := workItems.NewItemAccount(di.elasticProcessor, account)
	di.dispatcher.Add(wi)
}
