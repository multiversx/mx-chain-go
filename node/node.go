...
func (n *Node) broadcastBlock(blockBody data.BodyHandler, header data.HeaderHandler) error {
	...
	go n.messenger.Broadcast(factory.MiniBlocksTopic+
		n.shardCoordinator.CommunicationIdentifier(n.shardCoordinator.ShardForCurrentNode()), msgBlockBody)
	...
	go n.messenger.Broadcast(factory.HeadersTopic+
		n.shardCoordinator.CommunicationIdentifier(n.shardCoordinator.ShardForCurrentNode()), msgHeader)
