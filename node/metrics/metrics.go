...
func InitConfigMetrics(
	...
	appStatusHandler.SetUInt64Value(common.MetricESDTTransferAndExecuteAtomicityEnableEpoch, uint64(enableEpochs.ESDTTransferAndExecuteAtomicityEnableEpoch))
