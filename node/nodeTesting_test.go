...
func TestGenerateAndSendBulkTransactions_ZeroTxShouldErr(t *testing.T) {
	...
	err := n.GenerateAndSendBulkTransactions("", big.NewInt(0), 0, &mock.PrivateKeyStub{}, nil, []byte("chainID"))
	assert.NotNil(t, err)
...
func TestGenerateAndSendBulkTransactions_NilAccountAdapterShouldErr(t *testing.T) {
	...
	err := n.GenerateAndSendBulkTransactions(createDummyHexAddress(64), big.NewInt(0), 1, sk, nil, []byte("chainID"))
...
func TestGenerateAndSendBulkTransactions_NilPrivateKeyShouldErr(t *testing.T) {
	...
	err := n.GenerateAndSendBulkTransactions(createDummyHexAddress(64), big.NewInt(0), 1, nil, nil, []byte("chainID"))
	assert.NotNil(t, err)
...
func TestGenerateAndSendBulkTransactions_InvalidReceiverAddressShouldErr(t *testing.T) {
	...
	err := n.GenerateAndSendBulkTransactions("", big.NewInt(0), 1, sk, nil, []byte("chainID"))
	assert.NotNil(t, err)
...
func TestGenerateAndSendBulkTransactions_MarshalizerErrorsShouldErr(t *testing.T) {
	...
	err := n.GenerateAndSendBulkTransactions(createDummyHexAddress(64), big.NewInt(1), 1, sk, nil, []byte("chainID"))
	assert.NotNil(t, err)
...
func TestGenerateAndSendBulkTransactions_ShouldWork(t *testing.T) {
	...
	err := n.GenerateAndSendBulkTransactions(createDummyHexAddress(64), big.NewInt(1), uint64(noOfTx), sk, nil, []byte("chainID"))
	assert.Nil(t, err)
