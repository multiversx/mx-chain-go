...
// ErrShardOnlyEndpoint signals that an endpoint was called, but it is only available for shardchain nodes
var ErrShardOnlyEndpoint = errors.New("the endpoint is only available on shardchain nodes")
