...
require (
	...
	github.com/multiversx/mx-chain-vm-common-go v1.5.13-0.20240718081121-561b61a8f07f
	github.com/multiversx/mx-chain-vm-go v1.5.30-0.20240716073310-c7de86535df1
