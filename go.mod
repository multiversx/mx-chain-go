...
require (
	...
	github.com/ElrondNetwork/elastic-indexer-go v1.0.8-0.20210719081756-e0f2f1a89312
	github.com/ElrondNetwork/elrond-go-core v0.0.2-0.20210719092202-91d65b8aaad3
