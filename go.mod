...
require (
	...
	github.com/multiversx/mx-chain-vm-common-go v1.7.2-0.20260919102411-0aaae92d9f28
	github.com/multiversx/mx-chain-vm-go v1.5.50-0.20260919102227-848d687bbd8b
