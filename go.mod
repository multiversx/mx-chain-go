...
require (
	...
	github.com/ElrondNetwork/elastic-indexer-go v1.1.41-0.20220406120732-c0a926362226
	...
	github.com/ElrondNetwork/notifier-go v1.1.1-0.20220427110312-750b7f81d15d
