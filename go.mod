...
require (
	...
	github.com/ElrondNetwork/covalent-indexer-go v1.0.5-0.20211222113720-876525996034
	github.com/ElrondNetwork/elastic-indexer-go v1.1.29-0.20211222114031-b38f448aea38
