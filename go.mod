...
require (
	...
	github.com/ElrondNetwork/elastic-indexer-go v1.2.35-partial-execution.0.20220707115318-dd5be1f5e05c
	github.com/ElrondNetwork/elrond-go-core v1.1.16-0.20220711124837-3ed35795f664
