...
require (
	...
	github.com/multiversx/mx-chain-communication-go v1.3.2-0.20260526105332-149c7edf8889
	github.com/multiversx/mx-chain-core-go v1.4.2-0.20260505075936-43445d8a0f62
