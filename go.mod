...
require (
	...
	github.com/ElrondNetwork/elastic-indexer-go v1.0.8-0.20210722080634-b08956a8c136
	github.com/ElrondNetwork/elrond-go-core v1.0.1-0.20210722074726-15ae861b64c3
