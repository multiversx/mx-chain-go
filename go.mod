...
require (
	...
	github.com/multiversx/mx-chain-core-go v1.1.38-0.20230725095306-d7d22566df00
	...
	github.com/multiversx/mx-chain-storage-go v1.0.8-0.20230725094824-a1f58f2b5815
