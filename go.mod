...
require (
	...
	github.com/ElrondNetwork/arwen-wasm-vm/v1_4 v1.4.11
	github.com/ElrondNetwork/concurrent-map v0.1.3
	github.com/ElrondNetwork/elastic-indexer-go v1.1.14
...
replace github.com/ElrondNetwork/arwen-wasm-vm/v1_4 v1.4.11 => github.com/ElrondNetwork/arwen-wasm-vm v1.4.11
