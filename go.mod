...
require (
	...
	github.com/ElrondNetwork/elastic-indexer-go v1.1.13
...
replace github.com/ElrondNetwork/arwen-wasm-vm/v1_4 v1.4.8 => github.com/ElrondNetwork/arwen-wasm-vm v1.4.9
