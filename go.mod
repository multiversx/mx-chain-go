...
require (
	...
	github.com/ElrondNetwork/covalent-indexer-go v1.0.5-0.20211222085255-2e133c519277
	github.com/ElrondNetwork/elastic-indexer-go v1.1.29-0.20211222092047-7f60cd184c6f
