...
require (
	github.com/ElrondNetwork/elastic-indexer-go v1.3.2
	...
	github.com/ElrondNetwork/elrond-go-storage v1.0.2-0.20221010123311-cd57ab64f082
	...
	github.com/ElrondNetwork/wasm-vm-v1_4 v1.4.65
