...
require (
	...
	github.com/ElrondNetwork/covalent-indexer-go v1.0.7-0.20220201134600-2c993a02fe07
	github.com/ElrondNetwork/elastic-indexer-go v1.1.33-0.20220201123616-fafd4b190155
