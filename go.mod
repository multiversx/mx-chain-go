...
require (
	...
	github.com/multiversx/mx-chain-storage-go v1.0.9-0.20230516122642-c47b66209ce1
	github.com/multiversx/mx-chain-vm-common-go v1.4.2-0.20230516122803-af76f55aef6b
