...
var errTooManyUniqueAccountsInBlock = errors.New("too many unique accounts in block")
var errTransactionNotAllowedDueToPendingChangeGuardian = errors.New("transaction not allowed due to pending change guardian")
