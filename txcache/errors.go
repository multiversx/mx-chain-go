...
var errNilLatestCommittedBlockHash = errors.New("nil latest committed block hash")
...
var errNegativeBalance = errors.New("breadcrumb should not have negative balance")
