...
// updateFirstNonce is called only in the updateNonceRange method
func (breadcrumb *accountBreadcrumb) updateFirstNonce(firstNonce core.OptionalUint64) {
	breadcrumb.firstNonce = firstNonce
}
