...
func Test_computeSenderScore(t *testing.T) {
	require.InDelta(t, float64(0.1789683371), computeSenderScore(senderScoreParams{count: 14000, size: kBToBytes(100000), fee: toMicroERD(300000), gas: 2500000000, minGasPrice: 100}), delta)
	require.InDelta(t, float64(0.2517997181), computeSenderScore(senderScoreParams{count: 19000, size: kBToBytes(3000), fee: toMicroERD(2300000), gas: 19000000000, minGasPrice: 100}), delta)
	require.InDelta(t, float64(5.795382396), computeSenderScore(senderScoreParams{count: 3, size: kBToBytes(2), fee: toMicroERD(40), gas: 400000, minGasPrice: 100}), delta)
	require.InDelta(t, float64(100), computeSenderScore(senderScoreParams{count: 1, size: kBToBytes(0.3), fee: toMicroERD(50), gas: 100000, minGasPrice: 100}), delta)
}
