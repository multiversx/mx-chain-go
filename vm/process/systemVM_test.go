...
func createMockArguments() ArgsNewSystemVM {
	...
	gasMap[common.VMAPICost] = make(map[string]uint64)
	gasMap[common.VMAPICost][common.AsyncCallStepField] = 1000
	gasMap[common.VMAPICost][common.AsyncCallbackGasLockField] = 3000
