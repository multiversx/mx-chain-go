...
type DelegationManagement struct {
	...
	MinDeposit          *math_big.Int `protobuf:"bytes,5,opt,name=MinDeposit,proto3,casttypewith=math/big.Int;github.com/multiversx/mx-chain-core-go/data.BigIntCaster" json:"MinDeposit"`
	MinDelegationAmount *math_big.Int `protobuf:"bytes,6,opt,name=MinDelegationAmount,proto3,casttypewith=math/big.Int;github.com/multiversx/mx-chain-core-go/data.BigIntCaster" json:"MinDelegationAmount"`
}
...
type DelegationConfig struct {
	MaxDelegationCap            *math_big.Int `protobuf:"bytes,1,opt,name=MaxDelegationCap,proto3,casttypewith=math/big.Int;github.com/multiversx/mx-chain-core-go/data.BigIntCaster" json:"MaxDelegationCap"`
	InitialOwnerFunds           *math_big.Int `protobuf:"bytes,2,opt,name=InitialOwnerFunds,proto3,casttypewith=math/big.Int;github.com/multiversx/mx-chain-core-go/data.BigIntCaster" json:"InitialOwnerFunds"`
...
type DelegatorData struct {
	...
	UnClaimedRewards      *math_big.Int `protobuf:"bytes,4,opt,name=UnClaimedRewards,proto3,casttypewith=math/big.Int;github.com/multiversx/mx-chain-core-go/data.BigIntCaster" json:"UnClaimedRewards"`
	TotalCumulatedRewards *math_big.Int `protobuf:"bytes,5,opt,name=TotalCumulatedRewards,proto3,casttypewith=math/big.Int;github.com/multiversx/mx-chain-core-go/data.BigIntCaster" json:"TotalCumulatedRewards"`
}
...
type GlobalFundData struct {
	TotalActive   *math_big.Int `protobuf:"bytes,1,opt,name=TotalActive,proto3,casttypewith=math/big.Int;github.com/multiversx/mx-chain-core-go/data.BigIntCaster" json:"TotalActive"`
	TotalUnStaked *math_big.Int `protobuf:"bytes,2,opt,name=TotalUnStaked,proto3,casttypewith=math/big.Int;github.com/multiversx/mx-chain-core-go/data.BigIntCaster" json:"TotalUnStaked"`
}
...
type RewardComputationData struct {
	RewardsToDistribute *math_big.Int `protobuf:"bytes,1,opt,name=RewardsToDistribute,proto3,casttypewith=math/big.Int;github.com/multiversx/mx-chain-core-go/data.BigIntCaster" json:"RewardsToDistribute"`
	TotalActive         *math_big.Int `protobuf:"bytes,2,opt,name=TotalActive,proto3,casttypewith=math/big.Int;github.com/multiversx/mx-chain-core-go/data.BigIntCaster" json:"TotalActive"`
