...
type DelegationContractStatus struct {
	...
	StakedBLSKeys    [][]byte      `protobuf:"bytes,4,rep,name=StakedBLSKeys,proto3" json:"StakedBLSKeys"`
	NotStakedBLSKeys [][]byte      `protobuf:"bytes,5,rep,name=NotStakedBLSKeys,proto3" json:"NotStakedBLSKeys"`
}
...
func (m *DelegationContractStatus) GetStakedBLSKeys() [][]byte {
	if m != nil {
		return m.StakedBLSKeys
	}
	return nil
}

func (m *DelegationContractStatus) GetNotStakedBLSKeys() [][]byte {
	if m != nil {
		return m.NotStakedBLSKeys
	}
	return nil
}
...
type NodesData struct {
	BLSKeys [][]byte `protobuf:"bytes,1,rep,name=BLSKeys,proto3" json:"BLSKeys"`
}
...
func (m *NodesData) GetBLSKeys() [][]byte {
	if m != nil {
		return m.BLSKeys
	}
	return nil
...
var fileDescriptor_b823c7d67e95582e = []byte{
	...
	,
}
...
func (this *DelegationContractStatus) Equal(that interface{}) bool {
	...
	if len(this.StakedBLSKeys) != len(that1.StakedBLSKeys) {
		return false
	}
	for i := range this.StakedBLSKeys {
		if !bytes.Equal(this.StakedBLSKeys[i], that1.StakedBLSKeys[i]) {
			return false
		}
	}
	if len(this.NotStakedBLSKeys) != len(that1.NotStakedBLSKeys) {
		return false
	}
	for i := range this.NotStakedBLSKeys {
		if !bytes.Equal(this.NotStakedBLSKeys[i], that1.NotStakedBLSKeys[i]) {
			return false
		}
	}
	return true
...
func (this *NodesData) Equal(that interface{}) bool {
	...
	if len(this.BLSKeys) != len(that1.BLSKeys) {
		return false
	}
	for i := range this.BLSKeys {
		if !bytes.Equal(this.BLSKeys[i], that1.BLSKeys[i]) {
			return false
		}
	}
	return true
...
func (this *DelegationContractStatus) GoString() string {
	...
	s = append(s, "StakedBLSKeys: "+fmt.Sprintf("%#v", this.StakedBLSKeys)+",\n")
	s = append(s, "NotStakedBLSKeys: "+fmt.Sprintf("%#v", this.NotStakedBLSKeys)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *NodesData) GoString() string {
	...
	s = append(s, "BLSKeys: "+fmt.Sprintf("%#v", this.BLSKeys)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *DelegationContractStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.NotStakedBLSKeys) > 0 {
		for iNdEx := len(m.NotStakedBLSKeys) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.NotStakedBLSKeys[iNdEx])
			copy(dAtA[i:], m.NotStakedBLSKeys[iNdEx])
			i = encodeVarintDelegation(dAtA, i, uint64(len(m.NotStakedBLSKeys[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
	if len(m.StakedBLSKeys) > 0 {
		for iNdEx := len(m.StakedBLSKeys) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.StakedBLSKeys[iNdEx])
			copy(dAtA[i:], m.StakedBLSKeys[iNdEx])
			i = encodeVarintDelegation(dAtA, i, uint64(len(m.StakedBLSKeys[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *NodesData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BLSKeys) > 0 {
		for iNdEx := len(m.BLSKeys) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.BLSKeys[iNdEx])
			copy(dAtA[i:], m.BLSKeys[iNdEx])
			i = encodeVarintDelegation(dAtA, i, uint64(len(m.BLSKeys[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *DelegationContractStatus) Size() (n int) {
	...
	if len(m.StakedBLSKeys) > 0 {
		for _, b := range m.StakedBLSKeys {
			l = len(b)
			n += 1 + l + sovDelegation(uint64(l))
		}
	}
	if len(m.NotStakedBLSKeys) > 0 {
		for _, b := range m.NotStakedBLSKeys {
			l = len(b)
			n += 1 + l + sovDelegation(uint64(l))
		}
	}
...
func (this *DelegationContractStatus) String() string {
	...
	s := strings.Join([]string{`&DelegationContractStatus{`,
		...
		`StakedBLSKeys:` + fmt.Sprintf("%v", this.StakedBLSKeys) + `,`,
		`NotStakedBLSKeys:` + fmt.Sprintf("%v", this.NotStakedBLSKeys) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *NodesData) String() string {
	...
	s := strings.Join([]string{`&NodesData{`,
		`BLSKeys:` + fmt.Sprintf("%v", this.BLSKeys) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *DelegationContractStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StakedBLSKeys", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StakedBLSKeys = append(m.StakedBLSKeys, make([]byte, postIndex-iNdEx))
			copy(m.StakedBLSKeys[len(m.StakedBLSKeys)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NotStakedBLSKeys", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NotStakedBLSKeys = append(m.NotStakedBLSKeys, make([]byte, postIndex-iNdEx))
			copy(m.NotStakedBLSKeys[len(m.NotStakedBLSKeys)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDelegation(dAtA[iNdEx:])
...
func (m *NodesData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.BLSKeys = append(m.BLSKeys, make([]byte, postIndex-iNdEx))
			copy(m.BLSKeys[len(m.BLSKeys)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDelegation(dAtA[iNdEx:])
