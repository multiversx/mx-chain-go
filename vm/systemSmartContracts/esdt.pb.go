...
type ESDTData struct {
	...
	CanFreeze      bool          `protobuf:"varint,6,opt,name=CanFreeze,proto3" json:"CanFreeze"`
	CanWipe        bool          `protobuf:"varint,7,opt,name=CanWipe,proto3" json:"CanWipe"`
	Upgradable     bool          `protobuf:"varint,8,opt,name=Upgradable,proto3" json:"CanUpgrade"`
	CanChangeOwner bool          `protobuf:"varint,9,opt,name=CanChangeOwner,proto3" json:"CanChangeOwner"`
	IsPaused       bool          `protobuf:"varint,10,opt,name=IsPaused,proto3" json:"IsPaused"`
	MintedValue    *math_big.Int `protobuf:"bytes,11,opt,name=MintedValue,proto3,casttypewith=math/big.Int;github.com/ElrondNetwork/elrond-go/data.BigIntCaster" json:"MintedValue"`
	BurntValue     *math_big.Int `protobuf:"bytes,12,opt,name=BurntValue,proto3,casttypewith=math/big.Int;github.com/ElrondNetwork/elrond-go/data.BigIntCaster" json:"BurntValue"`
}
...
var fileDescriptor_e413e402abc6a34c = []byte{
	...
	,
}
