...
type VoteSet struct {
	...
	UsedBalance *math_big.Int  `protobuf:"bytes,2,opt,name=UsedBalance,proto3,casttypewith=math/big.Int;github.com/ElrondNetwork/elrond-go/data.BigIntCaster" json:"UsedBalance"`
	TotalYes    *math_big.Int  `protobuf:"bytes,3,opt,name=TotalYes,proto3,casttypewith=math/big.Int;github.com/ElrondNetwork/elrond-go/data.BigIntCaster" json:"TotalYes"`
	TotalNo     *math_big.Int  `protobuf:"bytes,4,opt,name=TotalNo,proto3,casttypewith=math/big.Int;github.com/ElrondNetwork/elrond-go/data.BigIntCaster" json:"TotalNo"`
	TotalVeto   *math_big.Int  `protobuf:"bytes,5,opt,name=TotalVeto,proto3,casttypewith=math/big.Int;github.com/ElrondNetwork/elrond-go/data.BigIntCaster" json:"TotalVeto"`
	Claimed     bool           `protobuf:"varint,6,opt,name=Claimed,proto3" json:"Claimed"`
	VoteItems   []*VoteDetails `protobuf:"bytes,7,rep,name=VoteItems,proto3" json:"VoteItems"`
}
...
func (m *VoteSet) GetClaimed() bool {
	if m != nil {
		return m.Claimed
	}
	return false
...
var fileDescriptor_e18a03da5266c714 = []byte{
	...
	,
}
