...
func TestStakingSC_ExecuteInitTwoTimeShouldReturnUserError(t *testing.T) {
	stakeValue := big.NewInt(100)
	eei, _ := NewVMContext(&mock.BlockChainHookStub{}, hooks.NewVMCryptoHook(), &mock.ArgumentParserMock{}, &testscommonState.AccountsStub{}, &mock.RaterMock{})
	eei.SetSCAddress([]byte("addr"))
	args := createMockStakingScArguments()
	args.StakingSCConfig.MinStakeValue = stakeValue.Text(10)
	args.Eei = eei
...
func TestStakingSC_ExecuteStakeWrongStakeValueShouldErr(t *testing.T) {
	...
	eei, _ := NewVMContext(blockChainHook, hooks.NewVMCryptoHook(), &mock.ArgumentParserMock{}, &testscommonState.AccountsStub{}, &mock.RaterMock{})
	eei.SetSCAddress([]byte("addr"))
	args := createMockStakingScArguments()
	args.StakingSCConfig.MinStakeValue = stakeValue.Text(10)
	args.Eei = eei
...
func TestStakingSC_ExecuteFinalizeUnBoundBeforePeriodEnds(t *testing.T) {
	...
	}, hooks.NewVMCryptoHook(), &mock.ArgumentParserMock{}, &testscommonState.AccountsStub{}, &mock.RaterMock{})
	eei.SetSCAddress([]byte("addr"))
...
func Test_NoActionAllowedForBadRatingOrJailed(t *testing.T) {
	...
	accountsStub := &testscommonState.AccountsStub{}
