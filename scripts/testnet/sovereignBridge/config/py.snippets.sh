...
setGenesisContract() {
    ESDT_SAFE_INIT_PARAMS="${MIN_VALID_SIGNERS}@$(bech32ToHex $INITIATOR_ADDRESS)"
    FEE_MARKET_INIT_PARAMS="$(bech32ToHex $ESDT_SAFE_ADDRESS)@$(bech32ToHex $PRICE_AGGREGATOR_ADDRESS)"
