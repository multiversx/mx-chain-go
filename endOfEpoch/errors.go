...
// ErrNilSettingsHandler signals that nil end of epoch settings has been provided
...
// ErrNilSyncTimes signals that sync timer is nil
...
// ErrForceEndOfEpochCanBeNotCalledOnNewRound signals that force end of epoch was called on wrong round
var ErrForceEndOfEpochCanBeNotCalledOnNewRound = errors.New("invalid time to call force end of epoch, possible only on new round")
